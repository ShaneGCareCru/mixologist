...
void main() {
  group('HomeScreen Search Integration Tests', () {
    ...
    testWidgets('should fetch recipe when searching for known cocktail', (tester) async {
    ...
    testWidgets('should display loading screen during API call', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: HomeScreen(),
        ),
      ...
      expect(find.byType(HomeScreen), findsNothing); // Should have navigated away from home
    });
  });
