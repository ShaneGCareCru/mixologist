...
void main() {
  group('Image Loading Integration Tests', () {
    ...
    setUpAll(() async {
      ...
      try {
        ...
        sampleRecipeData = {
          ...
          'ingredients': [
            {
              'name': 'Gin', 
              'quantity': '2.5 oz',
              'image_url': 'https://via.placeholder.com/150x150/0000FF/FFFFFF?text=Gin'
            },
            {
              'name': 'Dry Vermouth', 
              'quantity': '0.5 oz',
              'image_url': 'https://via.placeholder.com/150x150/FF0000/FFFFFF?text=Vermouth'
            },
          ],
          'steps': ['Step 1', 'Step 2'],
          ...
          'cocktail_image_url': 'https://via.placeholder.com/400x300/00FF00/FFFFFF?text=Martini',
          'step_images': [
    ...
    testWidgets('should gracefully handle missing or invalid image URLs', (tester) async {
      ...
      testData['ingredients'] = [
        {'name': 'Test Ingredient', 'quantity': '1 oz', 'image_url': 'broken://url'},
      ];
    ...
    testWidgets('should maintain performance with multiple images', (tester) async {
      // Create recipe with many images to test performance
      final heavyImageData = Map<String, dynamic>.from(sampleRecipeData);
      heavyImageData['ingredients'] = List.generate(10, (index) => {
        'name': 'Ingredient $index',
        'quantity': '${index + 1} oz',
        'image_url': 'https://via.placeholder.com/150x150/000000/FFFFFF?text=Item$index'
      });
      // Ensure required fields exist
      heavyImageData['alcohol_content'] = sampleRecipeData['alcohol_content'];
      heavyImageData['preparation_time_minutes'] = sampleRecipeData['preparation_time_minutes'];
