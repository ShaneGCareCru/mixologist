...
import '../../../app.dart'; // For RecipeScreen - will be updated
...
class _AIAssistantPageState extends State<AIAssistantPage> {
  ...
  void _handleRecipeResponse(Map<String, dynamic> recipeData) {
    ...
    // TODO: Update this when RecipeScreen is moved to features/recipe/
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => Scaffold(
          appBar: AppBar(title: Text('Recipe: ${formattedRecipe['drink_name']}')),
