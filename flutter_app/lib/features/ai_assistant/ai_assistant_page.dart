...
class _AIAssistantPageState extends State<AIAssistantPage> {
  ...
  void _handleRecipeResponse(Map<String, dynamic> recipeData) {
    ...
    // TODO: Navigate to recipe screen when it's available
    final formattedRecipe = AIAssistantService.formatRecipeForScreen(recipeData);
    debugPrint('Recipe data received: $formattedRecipe');
    
    // For now, just show the recipe data as debug output
    setState(() {
      _subtitle = 'Recipe received: ${recipeData['drink_name'] ?? 'Cocktail'}';
    });
  }
